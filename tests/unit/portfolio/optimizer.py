"""Extended unit tests for portfolio._optimizer — covers kwargs constructor, fallback solver, sector constraints, min_holding, transactions, single-asset covariance, timeout, and cancellation."""
