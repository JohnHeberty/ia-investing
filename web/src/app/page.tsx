    ...
    <>
      <header className="page-head">
        <div>
          ...
          <p className="subtitle">Visão geral das suas carteiras de investimento e operações.</p>
        </div>
      ...
      {count === 0 ? (
        ...
        <section className="card card-pad section-gap">
          <div className="card-title">
            ...
            <span className="mono">
              {count} {count === 1 ? "carteira" : "carteiras"}
            </span>
          </div>
          <div className="mt-16">
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="mono text-14">{money.format(value)}</div>
